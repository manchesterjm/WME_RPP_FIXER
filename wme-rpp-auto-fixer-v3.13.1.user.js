...
(function() {
    ...
    console.log('Script loaded: WME RPP Auto-Fixer v3.13.1 - Fixed save counter reset, zoom level check, and RPP tracking');
                ...
                allRPPs.forEach(rpp => {
                    ...
                    if (!hasValidAddress(rpp)) {
                        ...
                        if (needsEntryPoint || needsLockFix) {
                            ...
                            const fixSucceeded = fixRPP(rpp, needsEntryPoint, needsLockFix, UpdateObject);
