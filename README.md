...
2. Open `wme-rpp-auto-fixer-v3.12.1.user.js` in this folder
...
```bash
npm install
npx eslint wme-rpp-auto-fixer-v3.12.1.user.js
```
...
|---------|---------|--------|
| 3.12.1 | Progress bar snake fix | ✅ Current |
| 3.12.0 | RPP tracking & scan duration | ✅ Stable |
| 3.11.0 | Auto-pause at 100 changes | ✅ Stable |
