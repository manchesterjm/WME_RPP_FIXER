...
2. Open `wme-rpp-auto-fixer-v3.13.1.user.js` in this folder
...
```bash
npm install
npx eslint wme-rpp-auto-fixer-v3.13.1.user.js
```
...
|---------|---------|--------|
| 3.13.1 | Bug fixes: save counter, zoom check, RPP tracking | ✅ Current |
